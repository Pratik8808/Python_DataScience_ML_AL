...
def DirectoryScanner(DirectoryPath):
    ...
    for foldername,SubFolderName,FileName in os.walk(DirectoryPath):
        for fname in FileName:
            ...
            fname=os.path.join(foldername,fname) # Check without this Os module mule issue zhala
    ...
    fobj.write(f"Total Empty Files Found and Deleted : {Empty_Files}\n")
